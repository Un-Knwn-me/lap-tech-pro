      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto stagger-animation">
          {loading ? (
            // Loading skeleton
            [...Array(4)].map((_, index) => (
              <div key={index} className="bg-gray-50 p-8 rounded-2xl shadow-lg border border-gray-100">
                <div className="animate-pulse">
            ...
            reviews.map((testimonial: Review, index: number) => (
              <div key={index} className="bg-gray-50 p-8 rounded-2xl shadow-lg hover-scale border border-gray-100">
                <div className="flex items-start space-x-4">
                  <Image
